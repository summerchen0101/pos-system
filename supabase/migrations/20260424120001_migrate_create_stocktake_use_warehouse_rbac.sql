-- Ensure create_stocktake / complete_stocktake use user_may_manage_stocktake_warehouse, not is_admin() only.
-- Some deployments never ran 20260122120047_migrate_pos_booth_stocktake.sql, leaving 20260122120037
-- admin-gated RPC; updating only the helper function then has no effect.
-- Depends on: user_may_manage_stocktake_warehouse (20260424120000) or equivalent.
