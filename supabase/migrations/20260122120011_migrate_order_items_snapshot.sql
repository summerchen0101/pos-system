-- Persist order line items + promotion snapshot; extend checkout RPC.
...
drop function if exists public.checkout_order_deduct_stock(integer, integer, integer, jsonb);
